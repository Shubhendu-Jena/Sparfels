...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint):
    ...
    if checkpoint:
        ...
        gaussians.restore_ft(model_params, opt)
    ...
    os.makedirs(scene.model_path + '/pose_ft', exist_ok=True)
    save_pose(scene.model_path + '/pose_ft' + "/pose_org.npy", gaussians.P, train_cams_init)
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        with torch.no_grad():
            ...
            if (iteration in saving_iterations):
                ...
                save_pose(scene.model_path + '/pose_ft' + f"/pose_{iteration}.npy", gaussians.P, train_cams_init)
