...
class GaussianExtractor(object):
    def __init__(self, gaussians, render, pipe, bg_color=None, nvs=False):
        """
    ...
    def reconstruction(self, viewpoint_stack):
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            render_pkg = self.render(viewpoint_cam, self.gaussians, camera_pose=get_tensor_from_camera(viewpoint_cam.world_view_transform.transpose(0, 1)), nvs=self.nvs)
